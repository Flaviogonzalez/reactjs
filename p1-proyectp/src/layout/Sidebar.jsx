...
const Sidebar = ({activarModal}) => {
  ...
  return (
    <div className={`z-50 fixed flex flex-col bg-indigo-900 h-5/6 top-2/4 left-0 -translate-y-2/4 mx-5 rounded-xl shadow-2xl overflow-hidden w-64 transition-all duration-1000 ${activarModal ? estilos.enabled : estilos.disabled}`}>
      {
